...
import data2 from '../utils/miserables2.json';
import data3 from '../utils/miserables3.json';
  ...
  useEffect(
    () => {
      ...
      if (nodes.length === 0 || links.length === 0)
        return <div>Please specify links and nodes</div>;
    ...
    [nodes, links, ref.current, selected],
  );
